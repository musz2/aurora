...
export const JOB_PACKS: JobPack[] = [
  ...
  },
  {
    ...
    qa: [
      ...
      qa("Scenario", "A team wants to bypass the platform for speed. How do you handle it?", "Understand the real friction, remove it in the platform (self-serve, faster onboarding), and keep guardrails. I enable the fast path rather than police the slow one."),
  ...
  },
  {
    ...
    qa: [
      ...
      qa("Scenario", "The team consistently misses sprint commitments. What do you do?", "Look at root causes (over-commitment, unclear stories, interruptions, hidden work), fix estimation and readiness, protect the team, and adjust. Data over blame."),
